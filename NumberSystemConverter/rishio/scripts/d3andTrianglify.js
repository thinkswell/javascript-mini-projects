!(function () {
    ...
    function qt() {
        var n = Lt(),
            t = Tt() - n;
        t > 24
            ? (isFinite(t) && (clearTimeout(tc), (tc = setTimeout(qt, t))),
              (nc = 0))
            : ((nc = 1), rc(qt));
    }
    function Lt() {
    ...
    function Ot(n) {
        ...
        function i(n, t, e) {
            ...
            return r
                ? ((n.m = A.get(r[0].toLowerCase())), e + r[0].length)
                : -1;
        }
        function o(n, t, e) {
            S.lastIndex = 0;
        ...
        return function (a) {
            function c(n) {
                for (var t = 0, e = d.length, r = n[1], u = 0; e > u; ++u)
                    for (
                        var i, o = 1, a = d[u], c = a.length, l = a[0];
                        c > o;
                        ++o
                    )
                        (i = a[o]),
    ...
    function gr(n, t) {
        ...
        return function (u, i, o, a) {
            ...
            for (var l, s = u; o > 0 ? s > i : i > s; s -= c)
                a.point(
                    (l = xe([e, -r * Math.cos(s), -r * Math.sin(s)]))[0],
                    l[1]
                );
        };
    }
    ...
    function xr() {
        function n(n, u) {
            ...
            (Yc += Math.atan2(
                Math.sqrt(
                    (a = o * Math.sin(a)) * a + (a = r * i - e * o * c) * a
                ),
                e * i + r * o * c
            )),
                (t = n),
    ...
    function iu(n, t) {
        var e,
            ...
            i = n.sort(ou).pop();
        for (
            Gc = [], Kc = new Array(n.length), Qc = new nu(), tl = new nu();
            ;

        )
            if (
                ((u = nl), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x)))
            )
                (i.x !== e || i.y !== r) &&
    ...
    function Cu(n, t) {
        ...
        return (
            ...
            function (r) {
                return (
                    1 + n * Math.pow(2, -10 * r) * Math.sin(((r - e) * La) / t)
                );
            }
        );
    }
    ...
    function Qi(n, t) {
        function e(e) {
            return i[
                ((u.get(e) || ("range" === t.t ? u.set(e, n.push(e)) : 0 / 0)) -
                    1) %
                    i.length
            ];
        }
        ...
        return (
            ...
            (e.rangeRoundBands = function (u, a, c) {
                ...
                return (
                    (i = r(
                        s + Math.round((f - s - (n.length - a) * h) / 2),
                        h
                    )),
                    l && i.reverse(),
                    (o = Math.round(h * (1 - a))),
    ...
    function xo(n, t) {
        return n.length < 3
            ...
            : n[0] +
                  _o(
                      (n.push(n[0]), n),
                      wo([n[n.length - 2]].concat(n, [n[1]]), t)
                  );
    }
    function bo(n, t) {
    ...
    function Eo(n) {
        for (
            var t, e, r = -1, u = n.length, i = u + 4, o = [], a = [];
            ++r < 4;
    ...
    function Lo(n) {
        for (
            var t, e, r, u, i = [], o = qo(n), a = -1, c = n.length - 1;
            ++a < c;
    ...
    function Io(n) {
        return function () {
            ...
            (t = this[n]) &&
                ...
                (t.active += 0.5),
                e.event &&
                    e.event.interrupt.call(this, this.__data__, e.index));
        };
    }
    function Yo(n, t, e) {
                ...
                ta.timer(
                    function (u) {
                        ...
                        function l(e) {
                            ...
                            return u >= 1
                                ? (o.event &&
                                      o.event.end.call(n, n.__data__, t),
                                  s())
                                : void 0;
                        }
                        function s() {
    ...
    function na(n) {
        ...
        return (
            t.selectNode(ua.body), t.createContextualFragment(n.responseText)
        );
    }
    ...
    (ta.bisectLeft = ha.left),
        ...
        (ta.zip = function () {
            ...
            for (
                var n = -1, t = ta.min(arguments, o), e = new Array(t);
                ++n < t;
        ...
        (_a.selectAll = function (n) {
            ...
            for (var u = -1, i = this.length; ++u < i; )
                for (var o = this[u], a = -1, c = o.length; ++a < c; )
                    (e = o[a]) &&
                        (r.push((t = ra(n.call(e, e.__data__, a, u)))),
                        (t.parentNode = e));
            return A(r);
        });
    var wa = {
    ...
    (ta.selection.enter = Z),
        ...
        (Sa.select = function (n) {
            for (
                var t, e, r, u, i, o = [], a = -1, c = this.length;
                ++a < c;
                ...
                for (var l = -1, s = u.length; ++l < s; )
                    (i = u[l])
                        ? (t.push(
                              (r[l] = e =
                                  n.call(u.parentNode, i.__data__, l, a))
                          ),
        ...
        (ta.behavior.zoom = function () {
            ...
            function h() {
                ...
                function t() {
                    ...
                    for (
                        var e = ta.event.changedTouches, u = 0, i = e.length;
                        i > u;
                        ++u
                    )
        ...
        [
            ...
            var e = (ac[n] = Ft(
                ...
                function (n) {
                    ...
                    return (
                        Math.floor((ac.dayOfYear(n) + ((e + t) % 7)) / 7) -
                        (e !== t)
                    );
                }
            ));
    ...
    (ta.geo.path = function () {
        ...
        (ta.geo.rotation = function (n) {
            function t(t) {
                return (
                    (t = n(t[0] * Da, t[1] * Da)), (t[0] *= Pa), (t[1] *= Pa), t
                );
            }
            return (
                (n = lr(
                ...
                (a.tick = function () {
                    ...
                    for (e = 0; _ > e; ++e)
                        (a = M[e]),
                            ...
                            (p = y * y + x * x) &&
                                ((p =
                                    (r * i[e] * ((p = Math.sqrt(p)) - u[e])) /
                                    p),
                                (y *= p),
                                (x *= p),
                                (h.x -=
                                    y * (d = f.weight / (h.weight + f.weight))),
                                (h.y -= x * d),
                                (f.x += y * (d = 1 - d)),
                                (f.y += x * d));
                    if (
                        (d = r * v) &&
                        ((y = l[0] / 2), (x = l[1] / 2), (e = -1), d)
                    )
                        for (; ++e < b; )
                            (a = m[e]),
                                (a.x += (y - a.x) * d),
                    ...
                    if (g)
                        for (
                            Ju((t = ta.geom.quadtree(m)), r, o), e = -1;
                            ++e < b;
    ...
    (ta.layout.hierarchy = function () {
        function n(u) {
            ...
            for (u.depth = 0; null != (i = o.pop()); )
                if (
                    (a.push(i), (l = e.call(n, i, i.depth)) && (c = l.length))
                ) {
                    for (var c, l, s; --c >= 0; )
                        o.push((s = l[c])),
                            (s.parent = i),
    ...
    ta.layout.stack = function () {
        function n(a, c) {
            ...
            for (p = 0; m > p; ++p)
                for (
                    u.call(n, l[0][p], (v = d[p]), s[0][p][1]), g = 1;
                    h > g;
                    ++g
                )
        ...
        (ta.layout.pack = function () {
            function n(n, i) {
                ...
                if (
                    ...
                    var f =
                        (r * (t ? 1 : Math.max((2 * a.r) / c, (2 * a.r) / l))) /
                        2;
                    Qu(a, function (n) {
                        n.r += f;
                    }),
                    ...
                    var o,
                        ...
                        v =
                            "slice" === g
                                ...
                                : Math.min(l.dx, l.dy);
                    for (
                        n(h, (l.dx * l.dy) / e.value), s.area = 0;
                        (c = h.length) > 0;
                        ...
                        s.push((o = h[c - 1])),
                            ...
                            "squarify" !== g || (a = r(s, v)) <= p
                                ...
                                : ((s.area -= s.pop().area),
                                  ...
                                  (s.length = s.area = 0),
                                  (p = 1 / 0));
                    s.length && (u(s, v, l, !0), (s.length = s.area = 0)),
                        i.forEach(t);
                }
            }
            function e(t) {
                ...
                if (r && r.length) {
                    var i,
                        ...
                        c = [];
                    for (
                        n(a, (o.dx * o.dy) / t.value), c.area = 0;
                        (i = a.pop());
        ...
        (Pl.each = function (n, t) {
            ...
            if (arguments.length < 2) {
                ...
                Y(this, function (u) {
                    ...
                    (
                        i.event ||
                        (i.event = ta.dispatch("start", "end", "interrupt"))
                    ).on(n, t);
                });
            return this;
        }),
    ...
    ta.svg.brush = function () {
        ...
        return (
            ...
            (n.clear = function () {
                return (
                    n.empty() || ((f = [0, 0]), (h = [0, 0]), (o = a = null)), n
                );
            }),
            (n.empty = function () {
...
function Trianglify(f) {
    ...
    "undefined" == typeof f && (f = {}),
        (this.options = {
            ...
            cellpadding: e(f.cellpadding, 0.1 * f.cellsize || 15),
            noiseIntensity: e(f.noiseIntensity, 0),
            x_gradient: e(f.x_gradient, Trianglify.randomColor()),
            format: e(f.format, "svg"),
            fillOpacity: e(f.fillOpacity, 1),
            strokeOpacity: e(f.strokeOpacity, 1),
        }),
        (this.options.y_gradient =
            f.y_gradient ||
            this.options.x_gradient.map(function (f) {
                return d3.rgb(f).brighter(0.5);
            }));
}
"undefined" != typeof module &&
    ...
    (Trianglify.Pattern = function (f, e, d) {
        ...
        (this.svgString = a.serializeToString(this.svg)),
    ...
    (Trianglify.Pattern.gradient_2d = function (f, e, d, a) {
        return function (c, b) {
            var t = d3.scale
                    .linear()
                    .range(f)
                    .domain(d3.range(0, d, d / f.length)),
                i = d3.scale
                    .linear()
                    .range(e)
                    .domain(d3.range(0, a, a / e.length));
            return d3.interpolateRgb(t(c), i(b))(0.5);
        };
    }),
    (Trianglify.Pattern.prototype.generatePolygons = function () {
            ...
            a = d3.range(e * d).map(function (d) {
                var a = d % e,
                    ...
                    b = Math.round(
                        -f.bleed +
                            a * f.cellsize +
                            Math.random() * (f.cellsize - 2 * f.cellpadding) +
                            f.cellpadding
                    ),
                    t = Math.round(
                        -f.bleed +
        ...
        return d3.geom.voronoi().triangles(a);
    }),
    (Trianglify.Pattern.prototype.generateSVG = function () {
        var f = this.options,
            e = Trianglify.Pattern.gradient_2d(
                f.x_gradient,
                f.y_gradient,
                this.width,
                this.height
        ...
        var c = a.append("g");
        if (f.noiseIntensity > 0.01) {
            var b = a.append("filter").attr("id", "noise");
            b.append("feTurbulence")
        ...
        return (
            this.polys.forEach(function (d) {
                var a = (d[0][0] + d[1][0] + d[2][0]) / 3,
                    b = (d[0][1] + d[1][1] + d[2][1]) / 3,
                    t = e(a, b),
                    i = c
                        .append("path")
                        .attr("d", "M" + d.join("L") + "Z")
                        .attr({ fill: t, stroke: t });
                1 != f.fillOpacity && i.attr("fill-opacity", f.fillOpacity),
                    1 != f.strokeOpacity &&
                        i.attr("stroke-opacity", f.strokeOpacity);
            }),
            a.node()
        );
    }),
